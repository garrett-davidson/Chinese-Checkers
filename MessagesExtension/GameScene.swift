...
class GameScene: SKScene {
    ...
    static let orangeStartingIndices = [MarbleIndex(( 4,  0)), MarbleIndex((4,   1)), MarbleIndex((4,   2)), MarbleIndex((4,   3)), MarbleIndex((5,   0)), MarbleIndex((5,   1)), MarbleIndex((5,   2)), MarbleIndex((6,   1)), MarbleIndex((6,   2)), MarbleIndex((7,    1))]
    static let purpleStartingIndices = [MarbleIndex(( 4,  9)), MarbleIndex((4,  10)), MarbleIndex((4,  11)), MarbleIndex((4,  12)), MarbleIndex((5,   9)), MarbleIndex((5,  10)), MarbleIndex((5,  11)), MarbleIndex((6,  10)), MarbleIndex((6,  11)), MarbleIndex((7,  10))]
    static let yellowStartingIndices = [MarbleIndex(( 9,  1)), MarbleIndex((10,  1)), MarbleIndex((10,  2)), MarbleIndex((11,  0)), MarbleIndex((11,  1)), MarbleIndex((11,  2)), MarbleIndex((12,  0)), MarbleIndex((12,  1)), MarbleIndex((12,  2)), MarbleIndex((12 ,  3))]
    static let blueStartingIndices =   [MarbleIndex(( 9, 10)), MarbleIndex((10, 10)), MarbleIndex((10, 11)), MarbleIndex((11,  9)), MarbleIndex((11, 10)), MarbleIndex((11, 11)), MarbleIndex((12,  9)), MarbleIndex((12, 10)), MarbleIndex((12, 11)), MarbleIndex((12, 12))]
